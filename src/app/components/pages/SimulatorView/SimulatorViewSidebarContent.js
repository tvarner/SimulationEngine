	...
	render: function() {
		return(
			<div style={this.props.styles.content}>
				<a key={4} className={'menu-button-link grow'} onClick={this.props.onOpenLoadSimulationModal} style={this.props.styles.sidebarLink}>Load Simulation</a>
				<a key={5} className={'menu-button-link grow'} onClick={this.props.onOpenSaveSimulationModal} style={this.props.styles.sidebarLink}>Save Simulation</a>
