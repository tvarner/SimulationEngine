...
// simulation
import simulation from './simulations/ExampleSimulation1/ExampleSimulation1'
...
export function initializeSimulation() {
	...
	engine.initializeModel(stateSpace, simulation); // <-- can also initialize state space here
}
