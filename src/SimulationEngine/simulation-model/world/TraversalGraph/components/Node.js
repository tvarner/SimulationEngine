...
export default class Node { 
    ...
    buildBody(radius, position) {
        ...
        if (this.type == "general" || this.type === undefined) {
            ...
            var material = new THREE.MeshBasicMaterial( {color: ColorModel.nodeColors.generalNodeColor, wireframe: true} ); // LAWN GREEN
            ...
            var geometry = new THREE.SphereGeometry(radius, 32, 32);
            var material = new THREE.MeshBasicMaterial( {color: ColorModel.nodeColors.actionNodeColor, wireframe: true} ); // ORANGE
            var bodyMesh = new THREE.Mesh( geometry, material );
