...
robot.links_geom["base"] = new THREE.CubeGeometry( 1, 0.4, 1 );
robot.links_geom["base"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0.2, 0) );

robot.links_geom["clavicle_right"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["clavicle_right"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["clavicle_left"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["clavicle_left"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["shoulder_right"] = new THREE.CubeGeometry( 0.3, 0.3, 0.7 );
robot.links_geom["shoulder_right"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.35) );

robot.links_geom["upperarm_right"] = new THREE.CubeGeometry( 0.3, 0.3, 0.7 );
robot.links_geom["upperarm_right"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.35) );

robot.links_geom["forearm_right"] = new THREE.CubeGeometry( 0.3, 0.3, 0.5 );
robot.links_geom["forearm_right"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.25) );
