...
const robot = new Object(); // or just {} will create new object
...
/*  threejs geometry definition template, will be used by THREE.Mesh() to create threejs object
	// create threejs geometry and insert into robot.links_geom data object
	robot.links_geom["link1"] = new THREE.CubeGeometry( 5+2, 2, 2 );

	// example of translating geometry (in object space)
	robot.links_geom["link1"].applyMatrix( new THREE.Matrix4().makeTranslation(5/2, 0, 0) );

	// example of rotating geometry 45 degrees about y-axis (in object space)
	var temp3axis = new THREE.Vector3(0,1,0);
	robot.links_geom["link1"].rotateOnAxis(temp3axis,Math.PI/4);
*/

// define threejs geometries and associate with robot links 
robot.links_geom = {};

robot.links_geom["base"] = new THREE.CubeGeometry( 1, 0.4, 2.3 );
robot.links_geom["base"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0) );

robot.links_geom["leg1_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg1_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg1_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg1_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg1_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg1_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg2_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg2_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg2_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg2_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg2_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg2_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg3_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg3_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg3_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg3_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg3_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg3_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg4_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg4_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg4_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg4_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg4_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg4_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg5_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg5_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg5_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg5_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg5_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg5_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg6_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg6_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg6_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg6_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg6_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg6_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg7_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg7_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg7_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg7_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg7_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg7_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );

robot.links_geom["leg8_upper"] = new THREE.CubeGeometry( 0.3, 0.3, 0.3 );
robot.links_geom["leg8_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.15) );

robot.links_geom["leg8_middle"] = new THREE.CubeGeometry( 0.3, 0.3, 0.6 );
robot.links_geom["leg8_middle"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.3) );

robot.links_geom["leg8_lower"] = new THREE.CubeGeometry( 0.3, 0.3, 1 );
robot.links_geom["leg8_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0, 0.5) );
