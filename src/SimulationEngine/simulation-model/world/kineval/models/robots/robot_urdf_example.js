...
robot.links_geom["link1"] = new THREE.CubeGeometry( 0.7+0.2, 0.5+0.2, 0.2 );
robot.links_geom["link1"].applyMatrix( new THREE.Matrix4().makeTranslation((0.5-0.2)/2, 0.5/2, 0) );

robot.links_geom["link2"] = new THREE.CubeGeometry( 0.5+0.2, 0.2, 0.2 );
robot.links_geom["link2"].applyMatrix( new THREE.Matrix4().makeTranslation(0.5/2, 0, 0) );

robot.links_geom["link3"] = new THREE.CubeGeometry( 0.5+0.2, 0.2, 0.2 );
robot.links_geom["link3"].applyMatrix( new THREE.Matrix4().makeTranslation(0.5/2, 0, 0) );

robot.links_geom["link4"] = new THREE.CubeGeometry( 0.5+0.2, 0.2, 0.2 );
robot.links_geom["link4"].applyMatrix( new THREE.Matrix4().makeTranslation(0.5/2, 0, 0) );
