...
const robot_boundary = [[-10,0,-10],[2,0,2]];
...
robot_obstacles[0] = {location:[[-5],[0.5],[0],[1]], radius:0.5}; 
robot_obstacles[1] = {location:[[-5],[0.5],[-1],[1]], radius:0.5}; 
robot_obstacles[2] = {location:[[-5],[0.5],[-2],[1]], radius:0.5}; 
robot_obstacles[3] = {location:[[-5],[0.5],[-3],[1]], radius:0.5}; 
robot_obstacles[4] = {location:[[-5],[0.5],[-4],[1]], radius:0.5}; 
robot_obstacles[5] = {location:[[-5],[0.5],[-5],[1]], radius:0.5}; 
robot_obstacles[6] = {location:[[-5],[0.5],[-6],[1]], radius:0.5}; 
robot_obstacles[7] = {location:[[-5],[0.5],[-7],[1]], radius:0.5}; 
robot_obstacles[8] = {location:[[-5],[0.5],[-8],[1]], radius:0.5}; 
robot_obstacles[9] = {location:[[-5],[0.5],[1],[1]], radius:0.5}; 
robot_obstacles[10] = {location:[[-5],[0.5],[2],[1]], radius:0.5}; 
