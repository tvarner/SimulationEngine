...
// debugger;
                                    ...
                                    mobileAgent.v = 5;
                                    var _randomColor = '#' + Math.floor(Math.random() * 16777215).toString(16);
                                    var randomColor = new THREE.Color(_randomColor);
...
// debugger;
...

                            {
                                ...
                                counter: function(traversalGraph) {
                                    ...
                                    var lane1 = traversalGraph.getLane("lane 1");
                                    var lane0ExitCounter = traversalGraph.getNormalizedLaneExitCounter("lane 0", lane1.exitPosition);
...
// debugger;
                                    // get lane 1, and lane 0 exit counter
                                    var lane1 = mobileAgent.traversalGraph.getLane("lane 1");
                                    var lane1EntryCounter = mobileAgent.traversalGraph.getNormalizedLaneExitCounter("lane 1", lane1.exitPosition);

                                    if (mobileAgent.reverse) {
                                        var activeActionPointCounter = _.isFunction(mobileAgent.activeActionPoint.counter) ? mobileAgent.activeActionPoint.counter(mobileAgent.traversalGraph) : mobileAgent.activeActionPoint.counter;             
                                        var distOverActionPointCounter = mobileAgent.counter - activeActionPointCounter;
...

                            {
                                ...
                                counter: function(traversalGraph) {
                                    // get lane 1, and lane 0 exit counter
                                    var lane2 = traversalGraph.getLane("lane 2");
                                    ...
                                    var lane0ExitCounter = traversalGraph.getNormalizedLaneExitCounter("lane 0", lane2.exitPosition);
...
// debugger;
                                    // get lane 1, and lane 0 exit counter
                                    var lane2 = mobileAgent.traversalGraph.getLane("lane 2");
                                    var lane2EntryCounter = mobileAgent.traversalGraph.getNormalizedLaneExitCounter("lane 2", lane2.exitPosition);
                        ...
                        actionPoints: [
                            {
                                ...
                                counter: function(traversalGraph) {
                                    ...
                                    var lane1tolane2ExitPosition = traversalGraph.getNode("lattice1_2_2_2").pathPosition;
                                    ...
                                    var lane1tolane2ExitCounter = traversalGraph.getNormalizedLaneExitCounter("lane 1", lane1tolane2ExitPosition);
                                ...
                                callback: function(mobileAgent) {
                                    var lane2 = mobileAgent.traversalGraph.getLane("lane 2");
                                    var lane2EntryCounter = mobileAgent.traversalGraph.getNormalizedLaneExitCounter("lane 2", lane2.entrancePosition);
...
// debugger;
...

                            {
                                ...
                                counter: function(traversalGraph) {
                                    ...
                                    var lane3ExitCounter = traversalGraph.getNormalizedLaneExitCounter("lane 3", lane4.exitPosition);
...
// debugger;
                                    // get lane 1, and lane 0 exit counter
                                    var lane4 = mobileAgent.traversalGraph.getLane("lane 4");
                                    var lane4EntryCounter = mobileAgent.traversalGraph.getNormalizedLaneExitCounter("lane 4", lane4.exitPosition);
...

                            {
                                ...
                                counter: function(traversalGraph) {
                                    // get lane 1, and lane 0 exit counter
                                    var lane5 = traversalGraph.getLane("lane 5");
                                    // or can retrieve a node can pass the position of that node to getNormalizedLaneExitCounter
                                    ...
                                    // distance from the beginning of lane 0 to the point of intersection with lane 2, whereby the 
                                    // the transitioning mobileAgent can exit onto lane 0 from lane 2 at the correct normalized position on lane 0. 
                                    var lane3ExitCounter = traversalGraph.getNormalizedLaneExitCounter("lane 3", lane5.exitPosition);
...
// debugger;
                                    // get lane 1, and lane 0 exit counter
                                    var lane5 = mobileAgent.traversalGraph.getLane("lane 5");
                                    var lane5EntryCounter = mobileAgent.traversalGraph.getNormalizedLaneExitCounter("lane 5", lane5.exitPosition);
                        ...
                        actionPoints: [
                            {
                                ...
                                counter: function(traversalGraph) {
                                    ...
                                    // will not work
                                    var lane4tolane5ExitPosition = traversalGraph.getNode("lattice2_2_2_2").pathPosition;
                                    ...
                                    // this normalized exit lane counter needs to be cached. expensive operation
                                    var lane4tolane5ExitCounter = traversalGraph.getNormalizedLaneExitCounter("lane 4", lane4tolane5ExitPosition);
                                    // the vertex where lane 1 exits onto lane 2
                                ...
                                callback: function(mobileAgent) {
                                    var lane5 = mobileAgent.traversalGraph.getLane("lane 5");
                                    var lane5EntryCounter = mobileAgent.traversalGraph.getNormalizedLaneExitCounter("lane 5", lane5.entrancePosition);
    ...
    getNextLane(mobileAgent, counter) {
        ...
        switch(mobileAgent.lane.id) {
            ...
            case "lane 2":
                ...
                var lane0 = mobileAgent.traversalGraph.getLane("lane 0");
                var lane1 = mobileAgent.traversalGraph.getLane("lane 1");
...
*/
            ...
            case "lane 5":
                ...
                var lane3 = mobileAgent.traversalGraph.getLane("lane 3");
                var lane4 = mobileAgent.traversalGraph.getLane("lane 4");
...
*/
    ...
    afterLaneSwitchCallback(mobileAgent) {
        ...
        var _activeActionIds = this._getActiveActionIds();
        var activeActionIds = _activeActionIds ? _activeActionIds : ["changeVelocityAndColor", "switchLane"]; // activeActionIds undefined 
// debugger;
...
// debugger;                
            var _actionPoints = _.each(mobileAgent.lane.path.actionPoints, (actionPoint) => {
                _.each(activeActionIds, (actionId) => { 
                    if (actionPoint.id == actionId) {
                        ...
                        var actionPointCounter = _.isFunction(actionPoint.counter) ? actionPoint.counter(mobileAgent.traversalGraph) : actionPoint.counter;
