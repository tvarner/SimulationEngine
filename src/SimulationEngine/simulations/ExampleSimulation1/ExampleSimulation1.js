...
var Simulation = { 
	...
	initializeModel: function(stateSpace, systemTimeLimit) {
	...
	initializeControls: function(stateSpace) {
        var _agentUpdateInterval = this.timeModel.AGENT_UPDATE_INTERVAL;
        var mobileAgents = stateSpace.traversalGraph.mobileAgents;
        var lattice1 = stateSpace.traversalGraph.getCluster("lattice1");
        var lattice2 = stateSpace.traversalGraph.getCluster("lattice2");
        ...
        stateSpace.view.controls = new function() {
            ...
            _.each(mobileAgents, (mobileAgent, i) => {
                var agentVelocityControl = 'AGENT_' + i.toString() + '_VELOCITY';
                ...
                var agentReverseControl = 'AGENT_' + i.toString() + '_REVERSE';
        ...
        // add folders
        var stateSpaceFolder = stateSpace.view.gui.addFolder('State Space');
        var controlsFolder = stateSpace.view.gui.addFolder('Simulation Controls');
